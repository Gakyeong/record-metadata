...
st.set_page_config(
    ...
    page_icon="C:\\Users\\daz96\\OneDrive\\Documents\\GitHub\\record-metadata\\Language\\Family Search Logo.png",
    layout="wide",
...
# Create an in-memory Excel file with all cases
def save_to_excel(df_dict):
    output = BytesIO()
